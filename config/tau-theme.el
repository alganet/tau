;;; tau-theme.el --- molokai theme with Emacs theme engine

;; Copyright (C) 2013 by Adam Lloyd
;; Copyright (C) 2013 by Syohei YOSHIDA

;; Author: Syohei YOSHIDA <syohex@gmail.com>
;; URL: https://github.com/alloy-d/color-theme-tau
;; Package-Version: 20151016.845
;; Version: 0.01
...
(custom-theme-set-faces
 ...
 '(default ((t (:background "#222222" :foreground "#F8F8F2"))))
 ...
 '(header-line ((t (:background "#222222" :foreground "#777777"))))
 '(elscreen-tab-background-face ((t (:background "#333333" :foreground "#777777"))))
 '(elscreen-tab-current-screen-face ((t (:background "#222222" :foreground "#777777"))))
 '(elscreen-separator-background-face ((t (:background "#333333" :foreground "#777777"))))
 '(elscreen-separator-current-screen-face ((t (:background "#222222" :foreground "#777777"))))
 '(elscreen-tab-control-face ((t (:background "#333333" :foreground "#777777"))))
 '(elscreen-tab-other-screen-face ((t (:background "#333333" :foreground "#777777"))))
 ...
 '(mode-line ((t (:background "#222222" :foreground "#777777"))))
 '(mode-line-buffer-id ((t (:background "#222222" :foreground "#777777"))))
 '(mode-line-inactive ((t (:background "#333333" :foreground "#777777"))))
 '(mode-line-mousable ((t (:background "#222222" :foreground "#777777"))))
 '(mode-line-mousable-minor-mode ((t (:background "#222222" :foreground "#777777"))))
 '(powerline-active1 ((t (:background "#333333" :foreground "#777777"))))
 '(powerline-active2 ((t (:background "#222222" :foreground "#777777"))))
 '(powerline-inactive1 ((t (:background "#333333" :foreground "#777777"))))
 '(powerline-inactive2 ((t (:background "#222222" :foreground "#777777"))))
 '(spaceline-highlight-face ((t (:background "#777777" :foreground "#333333"))))
 ...
 '(fringe ((t (:background "#222222" :foreground "#262626"))))
 '(linum ((t (:background "#222222" :foreground "#777777"))))
