...
(custom-theme-set-faces
 ...
 '(powerline-active1 ((t (:background "#333333" :foreground "#F8F8F2"))))
 '(powerline-active2 ((t (:background "#333333" :foreground "#F8F8F2"))))
 '(powerline-inactive1 ((t (:background "#333333" :foreground "#F8F8F2"))))
 '(powerline-inactive2 ((t (:background "#333333" :foreground "#F8F8F2"))))
